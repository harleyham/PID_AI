...
# ============================================================
# Pipeline p2 - Configuração central
# ============================================================

# Tipo de informação                Função correta
# Mensagem humana (debug, status)   p2_log_info
# Aviso	                            p2_log_warn
# Erro	                            p2_log_error
# Dado mensurável                   p2_metric
...
export LOG_FILE="$LOG_DIR/performance_p2.csv"
export PIPELINE_LOG="$LOG_DIR/pipeline_p2.log"
export METRICS_CSV="$LOG_DIR/performance_p2_metrics.csv"
